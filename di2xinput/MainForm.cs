    ...
    public partial class MainForm : Form
    {
        ...
        private void ApplyThemeToControls(Control parent)
        {
            foreach (Control control in parent.Controls)
            {
                ...
                {
                    textBox.BackColor = Color.FromArgb(39, 39, 42);
                    textBox.ForeColor = Color.White;
                    textBox.BorderStyle = BorderStyle.FixedSingle;
                }
                else if (control is ComboBox comboBox)
                {
                    comboBox.BackColor = Color.FromArgb(39, 39, 42);
                    comboBox.ForeColor = Color.White;
                    comboBox.FlatStyle = FlatStyle.Flat;
                }
                else if (control is DataGridView grid)
                {
                    grid.BackgroundColor = Color.FromArgb(30, 30, 34);
                    ...
                    grid.DefaultCellStyle.BackColor = Color.FromArgb(30, 30, 34);
                    ...
                    grid.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(36, 36, 40);
                    grid.AlternatingRowsDefaultCellStyle.ForeColor = Color.White;

                    grid.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(39, 39, 42);
                ...
                {
                    tabControl.BackColor = Color.FromArgb(18, 18, 20);
                    tabControl.ForeColor = Color.White;
                }
                else if (control is TabPage tabPage)
                {
                    tabPage.BackColor = Color.FromArgb(18, 18, 20);
                ...
                {
                    panel.BackColor = Color.FromArgb(18, 18, 20);
                }
                else if (control is GroupBox groupBox)
                {
                    groupBox.BackColor = Color.FromArgb(18, 18, 20);
